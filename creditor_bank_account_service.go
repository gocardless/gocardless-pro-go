...
type CreditorBankAccountService interface {
	...
	Validate(ctx context.Context, p CreditorBankAccountValidateParams, opts ...RequestOption) (
		*CreditorBankAccountValidateResult, error)
}
...
type CreditorBankAccountValidateParamsLocalDetails struct {
...
// CreditorBankAccountValidateParams parameters
type CreditorBankAccountValidateParams struct {
	Iban         string                                         `url:"iban,omitempty" json:"iban,omitempty"`
	LocalDetails *CreditorBankAccountValidateParamsLocalDetails `url:"local_details,omitempty" json:"local_details,omitempty"`
}

// Validate
// Validate bank details without creating a creditor bank account
func (s *CreditorBankAccountServiceImpl) Validate(ctx context.Context, p CreditorBankAccountValidateParams, opts ...RequestOption) (
	*CreditorBankAccountValidateResult, error) {
	...
	var result struct {
		...
		*CreditorBankAccountValidateResult
	}
	...
	if result.CreditorBankAccountValidateResult == nil {
		return nil, errors.New("missing result")
	}

	return result.CreditorBankAccountValidateResult, nil
}
